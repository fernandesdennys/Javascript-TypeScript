...
console.log(umaString.match(/[a-z]/g)); // Expressão regular (mandando a flag global "g").
console.log(umaString.match(/[a-zA-Z]/)); // Expressão regular que captura qualquer letra maiúscula dentro da string.
